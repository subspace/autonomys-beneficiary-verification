          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-amber-800">
                ...
                centralized exchanges do not support deposits from smart contract wallets, so tokens sent
                directly from your Safe to an exchange deposit address may be delayed, rejected, or lost.
                Before transferring, confirm the exchange accepts deposits from a Safe, or first move the
                tokens to a standard wallet you control. See{' '}
                <a
